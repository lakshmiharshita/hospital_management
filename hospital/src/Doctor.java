 ...
 * @author harshita
 */
public class Doctor extends java.awt.Frame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String sql="insert into DOCTOR(D_ID,NAME,GENDER,DEPARTMENT,ADDRESS,PH_NO) values (?,?,?,?,?,?)";
        try{Connection conn = DriverManager.getConnection("jdbc:derby://localhost:1527/hospitaldb", "harshita", "harshita1");
